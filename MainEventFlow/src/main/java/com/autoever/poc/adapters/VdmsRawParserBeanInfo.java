...
*/
public class VdmsRawParserBeanInfo extends SBSimpleBeanInfo {
	...
	*/
	public SBPropertyDescriptor[] getPropertyDescriptorsChecked() throws IntrospectionException {
		SBPropertyDescriptor[] p = {
				new JavaEnumPropertyDescriptor<VdmsRawParser.parserTypeEnum>("parserType", VdmsRawParser.class,
						VdmsRawParser.parserTypeEnum.class).displayName("Raw Message Type:").description(""), };
		return p;
	}
